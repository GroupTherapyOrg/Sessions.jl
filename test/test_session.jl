...
@testset "session.jl" begin
    ...
    # Auto-save tests using SessionsApp removed (TUI layer deleted)
    # Kept: headless Sessions.run() tests and edge cases below
    ...
    # exec-roundtrip tests using SessionsApp removed (TUI layer deleted)
