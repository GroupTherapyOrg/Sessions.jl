...
(function(){
  ...
  if (t === 'dark') {
    ...
    document.documentElement.classList.add('sl-theme-light');
        ...
        # --- Favicon (injected via JS since Therapy renders in body, not head) ---
        RawHtml("""<script>(function(){var l=document.createElement('link');l.rel='icon';l.type='image/svg+xml';l.href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cpath d='M22 20C22 20 31 20 40 33C49 20 58 20 58 20' fill='none' stroke='%23d4759a' stroke-width='6' stroke-linecap='round'/%3E%3Cpath d='M22 38C22 38 31 38 40 51C49 38 58 38 58 38' fill='none' stroke='%23d4759a' stroke-width='6' stroke-linecap='round' opacity='0.55'/%3E%3Cpath d='M22 56C22 56 31 56 40 69C49 56 58 56 58 56' fill='none' stroke='%23d4759a' stroke-width='6' stroke-linecap='round' opacity='0.22'/%3E%3C/svg%3E";document.head.appendChild(l)})();</script>"""),
