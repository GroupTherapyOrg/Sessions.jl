# DarkModeToggle.jl - Interactive dark/light mode toggle island
#
...
# Island definition for future Wasm compilation
# This will be used once Sessions.jl integrates Therapy.jl's compile_component
const DarkModeToggleIsland = island(:DarkModeToggle) do
