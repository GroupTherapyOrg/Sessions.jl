...
(a) **"Software"** means the Sessions.jl software and all associated packages, documentation, source code, specifications, algorithms, libraries, and binary and/or executable code included in the distribution, and any modifications, updates, or improvements made thereto by Licensor.
